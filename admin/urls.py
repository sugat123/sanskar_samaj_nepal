...
urlpatterns = [
    ...
    path('add/gallery/more-image', views.add_more_image, name='add_more_image'),
    ...
    path('send/mail/selected/contact/',views.send_mail_selected_contact,name='send_mail_selected_contact'),
    path('all/send/mail/volunteer/', views.send_mail_all_volunteer, name='send_mail_all_volunteer'),
    path('add/email/', views.add_emails, name='add_email'),
    path('view/emails/', views.view_emails, name='view_emails'),
    path('<int:id>/update/email/', views.update_email, name='update_email'),
    path('<int:id>/delete/email/', views.delete_email, name='delete_email'),
    path('password-reset/',
