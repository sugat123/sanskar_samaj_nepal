...
$(function(){
  ...
  new Morris.Bar({
    ...
    barColors: ['#dc3545', '#145388','#2a93d5'],
    gridTextSize: 11,
    hideHover: 'auto',
    resize: true
  });
  ...
  new Morris.Line({
    ...
    ykeys: ['a', 'b', 'c'],
    labels: ['Series A', 'Series B', 'Series C'],
    lineColors: ['#145388', '#28a745', '#2a93d5'],
    lineWidth: 1,
    ymax: 'auto 100',
    gridTextSize: 11,
    hideHover: 'auto',
  ...
  new Morris.Donut({
    ...
    colors: ['#145388','#28a745','#2a93d5','#b69329'],
    resize: true
  });
